...
namespace AW.DataAccess.Entities
{
    ...
    public partial class AdventureWorks2016CTP3Entities : DbContext
    {
        ...
        [DbFunction("AdventureWorks2016CTP3Entities", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AdventureWorks2016CTP3Entities].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
    
        [DbFunction("AdventureWorks2016CTP3Entities", "vSalesOrderDetail_extended_inmem")]
        public virtual IQueryable<vSalesOrderDetail_extended_inmem_Result> vSalesOrderDetail_extended_inmem()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<vSalesOrderDetail_extended_inmem_Result>("[AdventureWorks2016CTP3Entities].[vSalesOrderDetail_extended_inmem]()");
        }
    
        [DbFunction("AdventureWorks2016CTP3Entities", "vSalesOrderHeader_extended_inmem")]
        public virtual IQueryable<vSalesOrderHeader_extended_inmem_Result> vSalesOrderHeader_extended_inmem()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<vSalesOrderHeader_extended_inmem_Result>("[AdventureWorks2016CTP3Entities].[vSalesOrderHeader_extended_inmem]()");
        }
    
        [DbFunction("AdventureWorks2016CTP3Entities", "customerAccessPredicate")]
        public virtual IQueryable<customerAccessPredicate_Result> customerAccessPredicate(Nullable<int> territoryID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<customerAccessPredicate_Result>("[AdventureWorks2016CTP3Entities].[customerAccessPredicate](@TerritoryID)", territoryIDParameter);
        }
